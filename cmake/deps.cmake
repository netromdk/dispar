...
# Libiberty (part of GNU binutils)
set(FOUND_LIBIBERTY NO)
if (LIBIBERTY_INC_DIR AND LIBIBERTY_STATIC_LIB)
  if (EXISTS ${LIBIBERTY_INC_DIR} AND EXISTS ${LIBIBERTY_STATIC_LIB})
    add_definitions(-DHAS_LIBIBERTY)
    set(FOUND_LIBIBERTY YES)
  else()
    set(LIBIBERTY_INC_DIR "")
    set(LIBIBERTY_STATIC_LIB "")
  endif()
endif()
