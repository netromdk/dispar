...
TEST(Util, addrDataString)
{
  ...
  EXPECT_EQ(res, "0: 78 78 78                                           xxx") << res;

  res = Util::addrDataString(0xabcdef, QByteArray(3, 'x'));
  EXPECT_EQ(res, "ABCDEF: 78 78 78                                           xxx") << res;
...
ADC: 39 39 39 39 39 39 39 39  39 39 39 39 39            9999999999999)***")
    << res;
...
1030: 50 51 52 53 54 55 56 57  58                        PQRSTUVWX)***")
    << res;
}
