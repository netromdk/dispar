...
TEST(CpuType, types)
{
  ...
  EXPECT_EQ((int) CpuType::SPARC, 4);
  EXPECT_EQ((int) CpuType::I860, 5);
  EXPECT_EQ((int) CpuType::POWER_PC, 6);
  EXPECT_EQ((int) CpuType::POWER_PC_64, 7);
  EXPECT_EQ((int) CpuType::I386, 8);
  EXPECT_EQ((int) CpuType::I486, 9);
  EXPECT_EQ((int) CpuType::I486_SX, 10);
  EXPECT_EQ((int) CpuType::PENTIUM, 11);
  EXPECT_EQ((int) CpuType::PENTIUM_PRO, 12);
  EXPECT_EQ((int) CpuType::PENTIUM_II_M3, 13);
  EXPECT_EQ((int) CpuType::PENTIUM_II_M5, 14);
  EXPECT_EQ((int) CpuType::CELERON, 15);
  EXPECT_EQ((int) CpuType::CELERON_MOBILE, 16);
  EXPECT_EQ((int) CpuType::PENTIUM_3, 17);
  EXPECT_EQ((int) CpuType::PENTIUM_3_M, 18);
  EXPECT_EQ((int) CpuType::PENTIUM_3_Xeon, 19);
  EXPECT_EQ((int) CpuType::PENTIUM_M, 20);
  EXPECT_EQ((int) CpuType::PENTIUM_4, 21);
  EXPECT_EQ((int) CpuType::PENTIUM_4_M, 22);
  EXPECT_EQ((int) CpuType::ITANIUM, 23);
  EXPECT_EQ((int) CpuType::ITANIUM_2, 24);
  EXPECT_EQ((int) CpuType::XEON, 25);
  EXPECT_EQ((int) CpuType::XEON_MP, 26);
}
